...
public class AccountPageControllerTest
{
	...
	@Mock
	private SparAddressForm addressForm;
	@Mock
	UpdateEmailForm emailForm;
	@Mock
	SparUpdateProfileForm profileForm;
	@Mock
	...
	@Test
	public void shouldNotUpdatePassword() throws CMSItemNotFoundException, IOException, DuplicateUidException
	{
		BDDMockito.given(Boolean.valueOf(bindingResult.hasErrors())).willReturn(Boolean.TRUE);
	...
	@Test
	public void shouldNotUpdatePasswordNotEqual() throws CMSItemNotFoundException, IOException, DuplicateUidException
	{
	...
	@Test
	public void shouldNotUpdatePasswordNotValid() throws CMSItemNotFoundException, IOException, DuplicateUidException
	{
	...
	@Test
	public void shouldUpdatePassword() throws CMSItemNotFoundException, IOException, DuplicateUidException
	{
		BDDMockito.given(passwordForm.getCheckNewPassword()).willReturn(TEST_CODE);
		BDDMockito.given(passwordForm.getNewPassword()).willReturn(TEST_CODE);
		BDDMockito.given(passwordForm.getCurrentPassword()).willReturn(TEST_CODE);
