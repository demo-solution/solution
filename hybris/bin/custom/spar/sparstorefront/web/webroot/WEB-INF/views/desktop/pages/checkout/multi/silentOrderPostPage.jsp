		...
		<div class="span-14 append-1">
			<div id="checkoutContentPanel" class="clearfix">
				...
				<form:form id="silentOrderPostForm" name="silentOrderPostForm" modelAttribute="sopPaymentDetailsForm" class="create_update_payment_form" action="${paymentFormUrl}" method="POST">
					...
					<div class="required right"></div>
					<div class="description, headline clear">
						<label class="control-label " for="card_cardType">
							Payment type
							<span class="mandatory">
								<img width="5" height="6" alt="Required" title="Required" src="/store/_ui/desktop/common/images/mandatory.gif">
							</span>
						</label>
					</div>
					<!-- 
					<c:if test="${not empty paymentInfos}">
					 ...
					 -->
					<div class="cardForm">
					<div id="test_LoginPage_Item_card_cardType_$1" style="display:inline">
						<div class="controls">
						<select id="paymentOption" name="paymentOption" tabindex="1">
							<option value="001" disabled="disabled" selected="selected">Cash on Delivery (COD)</option>
						</select>
						</div>
					</div>
					<input id="card_cardType" type="hidden" name="card_cardType" class="text" tabindex="2" type="text" value="001"/>
					<input id="card_nameOnCard" type="hidden" name="card_nameOnCard" class="text" tabindex="2" type="text" value="SPAR"/>
					<input id="card_accountNumber" type="hidden" name="card_accountNumber" class="text" tabindex="3" type="text" value="4111111111111111" autocomplete="off"/>
					<input id="card_cvNumber" type="hidden" name="card_cvNumber" class="text" tabindex="4" type="text" value="123"/>
					<input id="ExpiryMonth" type="hidden" name="card_expirationMonth" class="text" tabindex="2" type="text" value="12"/>
					<input id="ExpiryYear" type="hidden" name="card_expirationYear" class="text" tabindex="2" type="text" value="2016"/>
					</div>
					<!-- 
					<div class="cardForm" >
