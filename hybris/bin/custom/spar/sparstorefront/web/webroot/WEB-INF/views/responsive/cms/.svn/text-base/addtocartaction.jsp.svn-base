	...
	<c:choose>
		...
		<c:otherwise>
			<ycommerce:testId code="addToCartButton">
				<button id="addToCartButton" type="${buttonType}" class="btn btn-success btn-group-justified btn-Green js-add-to-cart" disabled="disabled">
					<img  src="${commonResourcePath}/images/cart-icon-18x18.png" style="padding-right:1em"/><spring:theme code="basket.add.to.basket"/>
				</button>
			</ycommerce:testId>
		</c:otherwise>
	</c:choose>
