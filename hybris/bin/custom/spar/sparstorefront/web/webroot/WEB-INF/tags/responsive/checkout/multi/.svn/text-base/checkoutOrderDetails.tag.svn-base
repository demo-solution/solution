...
<%-- <div class="col-sm-6 col-md-5 col-lg-4 hidden-xs">
	<div class="checkout-order-summary">
		<div class="headline"><spring:theme code="checkout.multi.order.summary" text="Order Summary" /></div> --%>
            ...
            <h3 class="address-header">DELIVER TO THIS ADDRESS</h3>
					<multi-checkout:deliveryCartItems cartData="${cartData}" showDeliveryAddress="${showDeliveryAddress}" showCartitems="false" showAddress="true"/>
				</div>
			</div>	
