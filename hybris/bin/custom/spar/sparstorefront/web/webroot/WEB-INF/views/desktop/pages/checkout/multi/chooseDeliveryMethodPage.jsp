...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
	...
	<div class="span-14 append-1">
		<div id="checkoutContentPanel" class="clearfix">
			...
			<form:form id="selectDeliveryMethodForm" modelAttribute="homePageForm" action="${request.contextPath}/checkout/multi/delivery-method/select" method="get">
			Delivery Type:
			<form:select path="deliveryType">
				<%-- <form:option value="Please select Delivery Type"></form:option> --%>
				<form:option value="HD">Home Delivery</form:option>
				<%-- <form:options items="${deliveryTypeEnums}" itemValue="code"
					itemLabel="name" /> --%>
			</form:select><br></br>
			Delivery Slot: 
			<form:select id="delivery" path="deliverySlot">
