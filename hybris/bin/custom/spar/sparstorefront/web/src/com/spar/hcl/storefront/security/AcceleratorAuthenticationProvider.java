...
public class AcceleratorAuthenticationProvider extends CoreAuthenticationProvider
{
	...
	public Authentication authenticate(final Authentication authentication) throws AuthenticationException
	{
		...
		final Boolean existingUserLoginAgainViaSocialMedia = (Boolean)sessionService.getAttribute("existingUserLogin");
		sessionService.setAttribute("existingUserLogin" , null);
		sessionService.removeAttribute("existingUserLogin");
		if (null != existingUserLoginAgainViaSocialMedia && Boolean.TRUE.equals(existingUserLoginAgainViaSocialMedia))
		{
			...
			final Set getAuthoritiesSet = new HashSet(userDetails.getAuthorities());
			final UsernamePasswordAuthenticationToken result = new UsernamePasswordAuthenticationToken(userDetails.getUsername(),
					authentication.getCredentials(), getAuthoritiesSet);
