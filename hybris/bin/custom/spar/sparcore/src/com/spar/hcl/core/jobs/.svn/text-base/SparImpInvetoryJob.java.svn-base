 ...
 *
 */
public class SparImpInvetoryJob extends AbstractJobPerformable
{

	private final String filePathDest = Config.getParameter("sparcore.batch.impex.basefolder");
	private final String filePathSource = Config.getParameter("sparcore.import.file.path");
	private final String fileName = "SPAR_ECOM_INVENTORY_";
	private static final Logger LOG = Logger.getLogger(SparImpInvetoryJob.class);
	...
	public PerformResult perform(final CronJobModel arg0)
	{
		...
		if (source.exists())
		{
			try
			{
				...
				LOG.info("File transfered for import of inventory");
