...
/**
 * This class is used to index Name for variant products in Solr
 *
 * @author rohan_c
 *
 */
public class SparVariantsNameValueProvider extends AbstractPropertyFieldValueProvider implements Serializable, FieldValueProvider
{
			...
			final IndexedProperty indexedProperty)
	{
		...
		for (final VariantProductModel variantProductModel : variants)
		{
			...
			{
				final String name = variantProductModel.getName();
				names.add(name);
			}
		}
		addFieldValues(fieldValues, indexedProperty, names);
		return fieldValues;
	}
