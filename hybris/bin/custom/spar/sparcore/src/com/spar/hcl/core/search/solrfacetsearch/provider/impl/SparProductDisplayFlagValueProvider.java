 ...
 *
 */
public class SparProductDisplayFlagValueProvider extends ProductPriceValueProvider
{
			...
			final List prices) throws FieldValueProviderException
	{
		...
		for (final Object field : fieldNames)
		{
			...
			fieldValues.add(new FieldValue(fieldName, displayFlag));
		}
	}
