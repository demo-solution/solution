 ...
 *
 */
package com.spar.hcl.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("sparcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("sparcockpits.product.externalTaxes"));
