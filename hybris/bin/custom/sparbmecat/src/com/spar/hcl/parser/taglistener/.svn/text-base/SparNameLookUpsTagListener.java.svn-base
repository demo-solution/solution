...
/**
 * Parses the &lt;NameLookUps&gt; tag
 */
public class SparNameLookUpsTagListener extends DefaultBMECatTagListener
{
	 ...
	 * Default Constructor
	 */
	public SparNameLookUpsTagListener()
	{
		super();
	}
	 ...
	 */
	public SparNameLookUpsTagListener(final TagListener parent, final SparProductCategoryFeature categoryFeature)
	{
		super(parent);
	...
	protected Collection createSubTagListeners()
	{
		...
		{ new SparNameValueTagListener(this, categoryFeature) });
	}
	...
	{
		return SparbmecatConstants.XML.TAG.NAME_LOOKUPS;
	}
}
