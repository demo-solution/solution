 ...
 */
public class SparbackofficeManager extends GeneratedSparbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SparbackofficeManager.class.getName());
	 ...
	 */
	public static SparbackofficeManager getInstance()
	{
		return (SparbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SparbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SparbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SparbackofficeManager called.");
		}
	}
