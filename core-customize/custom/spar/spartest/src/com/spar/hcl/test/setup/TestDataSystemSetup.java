 ...
 *
 */
package com.spar.hcl.test.setup;
...
import com.spar.hcl.test.constants.SparTestConstants;
import com.spar.hcl.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SparTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/spartest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/spartest/import/reviews.impex");
			...
			importImpexFile(context, "/spartest/import/cstickets.impex");
		}
	}
}
