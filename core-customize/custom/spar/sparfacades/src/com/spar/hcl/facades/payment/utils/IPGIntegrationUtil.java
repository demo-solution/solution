 ...
 *
 */
package com.spar.hcl.facades.payment.utils;
...
public class IPGIntegrationUtil
{
	 ...
	 * @param dateNow
	 */
	public IPGIntegrationUtil(final String storeId, final String sharedSecret, final String charge, final String ccy,
			final Date dateNow)
	{
	...
	{
		final String stringToHash = (new StringBuilder(String.valueOf(storeId))).append(fmtDate).append(charge).append(currency)
				.append(sharedSecret).toString();
	 ...
	 * @param dateNow
	 */
	public void setParameters(final String storeId, final String sharedSecret, final String charge, final String ccy,
			final Date dateNow)
	{
		this.storeId = storeId;
		this.sharedSecret = sharedSecret;
