...
/**
 * This class is used for indexing Brand of variants for the corresponding products.
 *
 * @author rohan_c
 *
 */
public class SparVariantsBrandValueProvider extends AbstractPropertyFieldValueProvider implements Serializable,
		FieldValueProvider
{
			...
			final IndexedProperty indexedProperty)
	{
		...
		for (final VariantProductModel variantProductModel : variants)
		{
			...
			{
				addFieldValues(fieldValues, indexedProperty, variantProductModel.getBrand(Locale.ENGLISH));
			}
		}
		return fieldValues;
	}
