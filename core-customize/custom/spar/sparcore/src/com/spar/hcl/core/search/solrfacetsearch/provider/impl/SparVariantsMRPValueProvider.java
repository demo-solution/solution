...
/**
 * This class is used for indexing MRP of variants for the corresponding products.
 *
 * @author rohan_c
 *
 */
public class SparVariantsMRPValueProvider extends AbstractPropertyFieldValueProvider implements Serializable, FieldValueProvider
{
					...
					try
					{
						...
						if (!CollectionUtils.isEmpty(prices))
						{
							...
							for (final Object obj : prices)
							{
								...
								value = (Double) (price).getQualifiers().get(UNIT_MRP);
								final Warehouse priceWarheouse = (Warehouse) (price).getQualifiers().get(WAREHOUSE);
								priceValue = priceValue + priceWarheouse.getCode()
	...
	/**
	 * This method is used to add MRP for variants in Solr
	 * 
	 * @param indexedProperty
	 * @param fieldValues
	 * @param priceValue
