	...
	<c:url value="/cart/checkout" var="checkoutUrl"/>
		...
		<div id="addToCartLayer" class="add-to-cart">
			...
			<div class="cart_popup_error_msg">
				...
				<spring:theme code="${errorMsg}" arguments="${product.maxOrderQuantity},${quantity}"/>
				...
				<div class="details">						
					<c:if test="${errorMsg eq null}">
					<div class="qty">${quantity}&nbsp;<span><spring:theme code="popup.cart.quantity.added"/></span></div>					
					</c:if>
					<a class="name" href="${entryProductUrl}"><c:out value="${entry.product.name}"/></a>					
