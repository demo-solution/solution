...
<%-- <script src="${commonResourcePath}/js/jquery-1.11.2.min.js"></script> --%>
<script  type="text/javascript" src="${commonResourcePath}/js/jquery-ui.js"></script>		 
...
<script type="text/javascript" src="${commonResourcePath}/js/jssor.slider.min.js"></script>
...
<script type="text/javascript" src="${commonResourcePath}/js/acc.storemapped.js"></script>
...
<%-- Custom JS include --%>
<script type="text/javascript" src="${commonResourcePath}/js/custom-s.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/jquery.jscrollpane.min.js"></script>
