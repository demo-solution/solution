...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms
		{
			...
			String SparTopNavigationBarComponent = _Prefix + SparTopNavigationBarComponentModel._TYPECODE + _Suffix;
			...
			String PlpProductGridHeaderComponent = _Prefix + PlpProductGridHeaderComponentModel._TYPECODE + _Suffix;
			String CategoryCarouselComponent = _Prefix + CategoryCarouselComponentModel._TYPECODE + _Suffix;
			String AddOnCategoryCarouselComponent = _Prefix + AddOnCategoryCarouselComponentModel._TYPECODE + _Suffix;
		}
	}
	...
	interface Views
	{
		...
		interface Pages
		{
			interface Account
			{
				...
				String AccountRegisterOptionalPage = "pages/account/accountRegisterOptionalPage";
				String AccountWalletPage = "pages/account/accountWalletPage";
			}
			...
			interface StoreFinder
			{
				...
				/*
				 * String SparStoreFinderSearchPage = "pages/storeFinder/sparStoreFinderSearchPage"; String
				 * SparDeliverySlotsForStore = "pages/storeFinder/sparDeliverySlotsForStore";
				 */
			...
			interface Misc
			{
				...
				String MiscSiteMapCategorPage = "pages/misc/miscSiteMapCategorPage";
				String MiscSiteMapProductPage = "pages/misc/miscSiteMapProductPage";
				String MiscSiteMapStaticPage = "pages/misc/miscSiteMapStaticPage";
				String MiscSiteMapSubCategoryPage = "pages/misc/miscSiteMapSubCategoryPage";
			}
			...
			interface GiftSolution
			{
				String GiftingZoneTagPage = "pages/giftingZone/giftingZonePage";
			}
		}
