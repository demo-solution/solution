...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sparstorefront/electronics/en",
						"https://electronics.local:9002/sparstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sparstorefront/electronics/en",
						"https://electronics.local:9002/sparstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sparstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/sparstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sparstorefront/electronics/en",
						"https://electronics.local:9002/sparstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sparstorefront",
						"https://electronics.local:9002/sparstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sparstorefront",
						"https://electronics.local:9002/sparstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/sparstorefront/electronics/en",
						"https://electronics.local:9002/sparstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
