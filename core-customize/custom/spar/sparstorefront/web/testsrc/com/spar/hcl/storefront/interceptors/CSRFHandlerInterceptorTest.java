 ...
 *
 */
package com.spar.hcl.storefront.interceptors;
...
import com.spar.hcl.storefront.util.CSRFHandlerInterceptor;
import com.spar.hcl.storefront.util.CSRFTokenManager;
...
{
	private static final String SESSION_CSRF_ATTRIBUTE = "com.spar.hcl.storefront.util.CSRFTokenManager.tokenval";
